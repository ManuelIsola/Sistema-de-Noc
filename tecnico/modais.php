      ...
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="table-responsive">
              ...
              <table id="exemplo" class="table table-striped table-bordered">
        <thead>
            <tr>
                <th>Name</th>
                <th>Position</th>
...
<!-- #Tribuição de Tarefas -->
<div class="modal fade modal-dialog modal-xl" id="ModalArtribuirTarefa" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Atribuir Tarefa<i class="bi bi-person-fill-gear icon icon-clock"></i></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="col-md-3">
...
table.buttons().container()
    .appendTo('#exemplo_wrapper .col-md-12:eq(0)');
